    ...
    render() {
        return (
            <div className="mx-10 md:mx-16 lg:mx-20">
                ...
                {this.props.data.map((product) => <Product productData={product} />)}
            </div>
        )
    }
}
        ...
        return (
            <div className="flex flex-row flex-wrap border-2 border-t-0">
                ...
                <div className="w-1/4 p-2">
                    <Link className="inline-block mx-2 px-4 py-1 bg-blue-600 text-white rounded-sm hover:bg-blue-700 transition-background duration-150">Edit</Link>
                    <Link className="inline-block mx-2 px-4 py-1 bg-red-600 text-white rounded-sm hover:bg-red-700 transition-background duration-150">Remove</Link>
                </div>
            </div>
        )
    }
